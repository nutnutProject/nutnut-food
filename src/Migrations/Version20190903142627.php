 ...
 */
final class Version20190903142627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD activate_token LONGTEXT NOT NULL, CHANGE roles roles JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP activate_token, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
