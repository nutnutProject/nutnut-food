 ...
 */
final class Version20190903084108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, CHANGE email username VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, CHANGE username email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
