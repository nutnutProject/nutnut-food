 ...
 */
final class Version20190904091736 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD pwd_token_expire INT NOT NULL, ADD activate_token_expire INT NOT NULL, ADD account_activate TINYINT(1) NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE activate_token activate_token LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP pwd_token_expire, DROP activate_token_expire, DROP account_activate, CHANGE activate_token activate_token LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
